    ...
    <>
      ...
      <div className={styles.grid}>
        <div className={theme.card}>
          ...
          <div className={styles.statValue}>{flats.length} / 30</div>
        ...
        <div className={theme.card}>
          ...
          <div className={styles.statSub}>
            <Link href="/living/app/disputes">Review queue →</Link>
          </div>
        </div>
        {membership.role === 'admin' && (
          <div className={theme.card}>
            ...
            <div className={styles.statSub}>
              <Link href="/living/app/setup">Review in Setup →</Link>
            </div>
          </div>
        )}
      </div>
      ...
      <div className={styles.section}>
        ...
        <div className={styles.rowList}>
          <div className={styles.row}>
            ...
            <Link href="/living/app/maintenance">Open →</Link>
          </div>
          {membership.role === 'admin' && (
            <div className={styles.row}>
              <span>Water readings entry</span>
              <Link href="/living/app/water">Open →</Link>
            </div>
          )}
          <div className={styles.row}>
            <span>Bill &amp; payment documents</span>
            <Link href="/living/app/documents">Open →</Link>
          </div>
        </div>
      </div>
    </>
...
async function BillSummaryCard({
  ...
  return (
    <div className={theme.card}>
      ...
      <Link href="/living/app/bill" className={theme.buttonGhost} style={{ display: 'inline-block', marginTop: '1rem' }}>
