...
async function addInventoryItemAction(formData: FormData) {
  ...
  if (!itemName) redirect('/living/app/inventory?error=' + encodeURIComponent('Name the item.'))
  ...
  if (error) redirect('/living/app/inventory?error=' + encodeURIComponent(error.message))
  redirect('/living/app/inventory?notice=' + encodeURIComponent('Added.'))
}
...
async function deleteInventoryItemAction(formData: FormData) {
  ...
  if (error) redirect('/living/app/inventory?error=' + encodeURIComponent(error.message))
  redirect('/living/app/inventory?notice=' + encodeURIComponent('Removed.'))
}
